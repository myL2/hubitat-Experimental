...
metadata {
	...
	// END:  getMetadataPreferencesForZigbeeDevicesWithBattery()
        ...
        input(name: "logOpenCloseDatetime", type: "bool", title: styling_addTitleDiv("Log Open/Close Time"), description: styling_addDescriptionDiv("Logs the date and time of when the last Open/Closed event occured (default: false)"), defaultValue: true)
