...
metadata {
    definition(name: 'ZemiSmart Zigbee Blind Mod2', namespace: 'myL2', author: 'SebyM', importUrl: '', singleThreaded: true ) {
        capability 'Actuator'
...
@Field final Map MODE_MAP = [1: 'lift', 0: 'tilt', 2: '2', 3: '3', 4: '4', 5: '5']
...
void setPosition(final BigDecimal positionParam) {
    ...
    int lastPosition = device.currentValue('position') ?: 0
    if (lastPosition < position) { 
        actualPercentageAdjust = percentageAdjustOpen?:0
    } else {
